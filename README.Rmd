...
[![Coverage Status](https://img.shields.io/codecov/c/github/MSKCC-Epi-Bio/PROscorerTools/master.svg)](https://codecov.io/github/MSKCC-Epi-Bio/PROscorerTools?branch=master)
...
also provids the building blocks of the functions in the PROscorer package.
